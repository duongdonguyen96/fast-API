...
STAFF_TYPE_CODE = "NV_KD"
INDIRECT_STAFF_TYPE_CODE = "NV_GT_GT"

STAFF_TYPE = {
    STAFF_TYPE_CODE: "Mã nhân viên kinh doanh",
    INDIRECT_STAFF_TYPE_CODE: "Mã nhân viên giới thiệu gián tiếp"
}
