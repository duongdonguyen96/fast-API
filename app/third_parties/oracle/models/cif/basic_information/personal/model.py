...
class CustomerIndividualInfo(Base):
    ...
    title_id = Column(ForeignKey('crm_cust_title.cust_title_id'), comment='Mã Danh xưng khách hàng (ông, bà, ...)')
    ...
    guardian_flag = Column(NUMBER(1, 0, False), comment='Cờ có người giám hộ không')
