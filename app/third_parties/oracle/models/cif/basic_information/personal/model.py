...
class CustomerIndividualInfo(Base):
    ...
    country_of_birth = relationship('CrmAddressCountry')
    customer_fatca = relationship('CrmCustFatca')
    gender = relationship('CrmCustGender')
    marital_status = relationship('CrmMaritalStatu')
    nation = relationship('CrmNation')
    place_of_birth = relationship('CrmAddressProvince')
    religion = relationship('CrmReligion')
    resident_status = relationship('CrmResidentStatu')
    title = relationship('CrmCustTitle')
