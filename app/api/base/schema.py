...
class UserInfo(BaseSchema):
    ...
    department_id: str | None = Field(None, description='Phòng ban', example='ddonguyen@cmc.com.vn')
    company_id: str | None = Field(None, description='Công ty', example='ddonguyen@cmc.com.vn')
